    ...
    <div>
        ...
        <div class="feed-element">
            <a href="index_3.html#" class="pull-left">
                <img alt="image" class="img-circle" src="<?php echo base_url();?>public/img/a1.jpg">
            </a>
        ...
        <div class="feed-element">
            <a href="index_3.html#" class="pull-left">
                <img alt="image" class="img-circle" src="<?php echo base_url();?>public/img/a2.jpg">
            </a>
        ...
        <div class="feed-element">
            <a href="index_3.html#" class="pull-left">
                <img alt="image" class="img-circle" src="<?php echo base_url();?>public/img/a3.jpg">
            </a>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <p><a class="text-info" href="index_3.html#">@小七是</a>
                        ...
                        <li class="list-group-item">
                            <p><a class="text-info" href="index_3.html#">@镜子mini</a>
                        ...
                        <li class="list-group-item ">
                            <p><a class="text-info" href="index_3.html#">@爱nimen</a>
