                        ...
                        <form class="form-horizontal m-t">
                            ...
                            <div class="form-group draggable">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="describe" id="describe" class="form-control"
                                           placeholder="请输入分类描述" required="required">
                                </div>
                            </div>
                            <div class="form-group draggable">
                            ...
                            <div class="form-group draggable">
                                <div class="col-sm-12 col-sm-offset-3">
                                    <button class="btn btn-primary" type="button" onclick="add_product_type()">
                                        添加分类
                                    </button>
...
<script>
    function add_product_type() {
        ...
        url = '<?php echo base_url(); ?>index.php/product/addProductType';
        var data = {
            type_name: type_name,
            describe: describe,
            parent_id: parent_id
